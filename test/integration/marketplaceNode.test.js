...
test("SELL then BUY updates balances, emits payment request, and stores latest song state", async () => {
...
test("processing enough SELL transactions triggers mining reward and appends a block", async () => {
  const originalPost = axios.post;
